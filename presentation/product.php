		...
		if (isset($_SESSION['link_to_continue_shopping']))
		{
			...
			if (isset($continue_shopping['CategoryId']))
			{
				$this->mLinkToContinueShopping =
					Link::ToCategory((int)$continue_shopping['DepartmentId'], (int)$continue_shopping['CategoryId'], $page);
			}
			...
			{
				$this->mProduct['image'] =
					Link::Build('product_image/' . $this->mProduct['image']);
			}

			if ($this->mProduct['image_2'])
			{
				$this->mProduct['image_2'] =
					Link::Build('product_image/' . $this->mProduct['image_2']);
			}	
